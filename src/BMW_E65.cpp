...
void BMW_E65Class::DashOn()
{
    ...
    if (!this->dashInit)
    {
        for (int i = 0; i < 3; i++)
        {
            Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x332, (uint32_t*)bytes,2); //Send on CAN2
        }
    }
    this->dashInit=true;
...
//uint8_t bytes_RPM[4];
    ...
    bytes[6]=0x80;
    bytes[7]=0x99;
    Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x0AA, (uint32_t*)bytes,8); //Send on CAN2
...
//////////send abs/dsc messages////////////////////////
    ...
    Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x0A8, (uint32_t*)bytes,8); //Send on CAN2
    ...
    Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x0A9, (uint32_t*)bytes,8); //Send on CAN2
    ...
    Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x0BA, (uint32_t*)bytes,7); //Send on CAN2
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    Can::GetInterface(Param::GetInt(Param::veh_can))->Send(0x1D2, (uint32_t*)bytes,5); //Send on CAN2
    ///////////////////////////
