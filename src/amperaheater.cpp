...
void AmperaHeater::SetPower(uint8_t power, bool heatReq)
{
   ...
   case 2:
      ...
      if(heatReq) txMessage_Ampera.frame.data1 = utils::change(power, 0, 100, 0, 133);//transmitt heater power command when requested
