...
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x112, (uint32_t*)bytes,8); //Send on CAN1
...
bytes[3] = 0x00;
bytes[4] = 0x8a;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x1a1, (uint32_t*)bytes,5); //Send on CAN1. average 20ms
}
...
bytes[6] = 0xff;
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x2fa, (uint32_t*)bytes,8); //Send on CAN1. this msg varies from 82ms to 1s intervals.
...
bytes[6] = 0x02;
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x432, (uint32_t*)bytes,8); //Send on CAN1. average 190ms
...
bytes[6] = 0x00;
bytes[7] = 0x1a;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x51a, (uint32_t*)bytes,8); //Send on CAN1. average 640ms
...
bytes[6] = 0xff;
bytes[7] = 0x40;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x540, (uint32_t*)bytes,8); //Send on CAN1. average 640ms
...
bytes[6] = 0x00;
bytes[7] = 0x00;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x510, (uint32_t*)bytes,8); //Send on CAN1. average 640ms
...
bytes[5] = 0x1e;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x328, (uint32_t*)bytes,6); //Send on CAN1
...
bytes[0] = 0xf1;
bytes[1] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x3e8, (uint32_t*)bytes,2); //Send on CAN1
...
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x3f9, (uint32_t*)bytes,8); //Send on CAN1.average 1s
...
bytes[6] = 0xff;
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x2fc, (uint32_t*)bytes,8); //Send on CAN1. average 5s.
...
bytes[6] = 0xff;
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x2a0, (uint32_t*)bytes,8); //Send on CAN1. average 5s.
...
bytes[6] = 0xff;
bytes[7] = 0xfc;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x3a0, (uint32_t*)bytes,8); //Send on CAN1. average 4s.
}
}
...
bytes[6] = 0xff;
bytes[7] = 0xff;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x03c, (uint32_t*)bytes,8); //Send on CAN1. average 100ms
...
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x3E9, (uint32_t*)bytes,8); //Send on CAN1. average 128ms
...
bytes[6] = 0xf3;
bytes[7] = 0x4b;
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x431, (uint32_t*)bytes,8); //Send on CAN1.average 197ms but as low as 49ms.
...
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x12f, (uint32_t*)bytes,8); //Send on CAN1. average 100ms
...
Can::GetInterface(Param::GetInt(Param::shunt_can))->Send(0x2f1, (uint32_t*)bytes,8); //Send on CAN1. average 100ms
