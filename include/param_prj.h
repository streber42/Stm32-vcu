...
#define PARAM_LIST \
    ...
    PARAM_ENTRY(CAT_SETUP,     CanMapCan,    CAN_DEV,  0,      1,      0,      96 ) \
    ...
    PARAM_ENTRY(CAT_THROTTLE,  usethrotmap, ONOFF,     0,      1,      0,      97 ) \
    ...
    PARAM_ENTRY(CAT_HEATER,    HeatTempMax, "°C",      0,      4096,   0,      91 ) \
    PARAM_ENTRY(CAT_HEATER,    HeatTempMin, "°C",      0,      4096,   2048,   92 ) \
    ...
    VALUE_ENTRY(HeaterTemp,    "dig",               2091 ) \
