...
#define PARAM_LIST \
    ...
    PARAM_ENTRY(CAT_HEATER,    HeatTempMax, "dig",     0,      4096,   0,      108 ) \
    PARAM_ENTRY(CAT_HEATER,    HeatTempMin, "dig",     0,      4096,   2048,   109 ) \
    PARAM_ENTRY(CAT_HEATER,    HeatPWMCh,   PWM_CH,    0,      2,      0,      112 ) \
